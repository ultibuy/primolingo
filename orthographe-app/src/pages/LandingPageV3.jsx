      ...
      <div style={css.page}>
        ...
        <section data-section="problem" style={css.section} className="oq-section">
          ...
          <p style={css.sectionSubtitle}>
            Votre enfant connaît la règle. Il l'a apprise, il a fait l'exercice.
          ...
          <div style={css.problemGrid}>
            <div style={css.problemCard}>
              ...
              <div style={css.problemDesc}>
                Une règle comprise aujourd'hui sera oubliée dans 3 semaines sans révision.
                C'est la courbe de l'oubli — et c'est tout à fait normal.
              </div>
            </div>
            <div style={css.problemCard}>
              <div style={css.problemEmoji}>😴</div>
              ...
              <div style={css.problemDesc}>
                Recopier des mots 10 fois ne crée pas de motivation.
                Et sans envie, pas de régularité. Sans régularité, pas de progrès durables.
              </div>
            </div>
            <div style={css.problemCard}>
              <div style={css.problemEmoji}>🎯</div>
              ...
              <div style={css.problemDesc}>
                Votre enfant maîtrise « ou/où » mais bloque sur « a/à » ?
                Il a besoin d'un programme qui s'adapte à lui.
              </div>
            </div>
          </div>
        </section>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center", marginBottom: 64 }} className="oq-two-col">
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              <img
                ...
                alt="Schémas d'apprentissage didactiques et logiques"
                style={css.illustrationImg}
              />
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center", marginBottom: 64 }} className="oq-two-col oq-reverse">
            <div style={{ display: "flex", justifyContent: "center", order: 0 }}>
              <img
                ...
                alt="Interface ludique de l'app"
                style={css.illustrationImg}
              />
            </div>
            <div style={{ order: 1 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center", marginBottom: 64 }} className="oq-two-col">
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              <img
                ...
                alt="Dates de révision personnalisées"
                style={css.illustrationImg}
              />
            </div>
          </div>
        ...
        <section data-section="dictee" style={css.section} className="oq-section">
          <div style={css.dicteeSection} className="oq-dictee-section">
            <div style={css.sectionLabel}>Mode Dictée</div>
            ...
            <div style={{ display: "flex", justifyContent: "center", marginBottom: 36 }}>
              <img
                ...
                alt="Mode dictée de GramHero"
                style={{ ...css.illustrationImg, maxWidth: 500 }}
              />
            </div>

            <div style={css.dicteeGrid} className="oq-three-col">
              <div style={css.dicteeCard}>
                <div style={{ fontSize: 32, marginBottom: 10 }}>🌱</div>
                <div style={{ fontFamily: T.fontDisplay, fontWeight: 700, fontSize: 17, marginBottom: 6, color: T.green }}>Aventurier</div>
                <div style={{ fontSize: 13, color: T.textMuted, lineHeight: 1.5 }}>
                  Les mots courants du texte. Idéal pour commencer en douceur.
                </div>
              </div>
              <div style={css.dicteeCard}>
                <div style={{ fontSize: 32, marginBottom: 10 }}>⚡</div>
                <div style={{ fontFamily: T.fontDisplay, fontWeight: 700, fontSize: 17, marginBottom: 6, color: T.orange }}>Héros</div>
                <div style={{ fontSize: 13, color: T.textMuted, lineHeight: 1.5 }}>
                  Des mots plus complexes pour progresser. Le vocabulaire s'enrichit.
                </div>
              </div>
              <div style={css.dicteeCard}>
                <div style={{ fontSize: 32, marginBottom: 10 }}>👑</div>
                <div style={{ fontFamily: T.fontDisplay, fontWeight: 700, fontSize: 17, marginBottom: 6, color: T.gold }}>Légende</div>
                <div style={{ fontSize: 13, color: T.textMuted, lineHeight: 1.5 }}>
                  Le texte complet. La dictée ultime pour les plus courageux.
                </div>
              </div>
            </div>
          ...
          <div style={css.parentSection} className="oq-two-col">
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              <img
                ...
                alt="Personnages à collectionner"
                style={css.illustrationImg}
              />
            </div>
          </div>
